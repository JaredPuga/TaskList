  ...
  return (
    <div className="flex items-center justify-between p-4 bg-gray-700 border-b border-solid border-gray-600">
        ...
        <div className="flex items-center space-x-5">
            <ButtonFilter action={() => showAllTasks()} active={activeFilter} filter='All'/>
            <ButtonFilter action={() => showToDoTask()} active={activeFilter} filter='To do'/>
            <ButtonFilter action={() => showCompletedTask()} active={activeFilter} filter='Completed'/>
        </div>
        <button 
